...
const ImgInput = (props) => {
  ...
  const handleClick = async() => {
    try{
      ...
      data.append("upload_preset", "wnmf8jec")
      data.append("cloud_name", "dphq30po1")
      const response = await fetch("https://api.cloudinary.com/v1_1/dphq30po1/image/upload", {method:"POST", body: data})
